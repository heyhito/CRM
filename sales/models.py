...
class Customer(models.Model):
    ...
    name = models.CharField('姓名', max_length=32,  null=True, help_text='学员报名后，请改为真实姓名') #可为空，有些人就不愿意给自己的真实姓名
    sex = models.CharField("性别", choices=sex_type, max_length=16, null=True) #存的是male或者female，字符串
